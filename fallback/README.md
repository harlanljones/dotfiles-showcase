...
| `shell-env.json` | SYNTHETIC | `~/.zshrc`, `~/.bashrc`, `~/.config/shell/*.sh`, `~/.config/environment.d/` | hand-authored sanitized snapshot (exports, PATH precedence, env.d vars); host literals replaced (`~`, `<host>`), no credentials |
